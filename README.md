...
2. [由两个栈组成的队列](https://github.com/liuenci/Leetcode/blob/master/src/com/cier/solution/StackAndQueue/MyQueue.java)

3. [如何仅用递归函数和栈操作逆序一个栈](https://github.com/liuenci/Leetcode/blob/master/src/com/cier/solution/StackAndQueue/ReverseStack.java)

4. [猫狗队列](https://github.com/liuenci/Leetcode/blob/master/src/com/cier/solution/StackAndQueue/DogCatQueue.java)

5. [用一个栈实现另一个栈的排序](https://github.com/liuenci/Leetcode/blob/master/src/com/cier/solution/StackAndQueue/TwoStacks.java)

6. [用栈来求解汉诺塔问题](https://github.com/liuenci/Leetcode/blob/master/src/com/cier/solution/StackAndQueue/Hanoi.java)

7. [生成窗口最大值数组](https://github.com/liuenci/Leetcode/blob/master/src/com/cier/solution/StackAndQueue/MaxWindow.java)

8. [构造数组的 MaxTree](https://github.com/liuenci/Leetcode/commit/82e6c5249b871783433d3a3f19e28bf0b800187c)
